...
- [#17](https://github.com/ActiveEngagement/capsule-capsulate/pull/17) [`6d39408`](https://github.com/ActiveEngagement/capsule-capsulate/commit/6d394086c5d78053d5aef6012b5ff91f93d2407a) Thanks [@actengage](https://github.com/actengage)! - Surface the real cause when style inlining fails. `InlineCss` used to catch any
...
- [#9](https://github.com/ActiveEngagement/capsule-capsulate/pull/9) [`8f5bda4`](https://github.com/ActiveEngagement/capsule-capsulate/commit/8f5bda40af27f185e722b437c16b1ae3d412fbe7) Thanks [@actengage](https://github.com/actengage)! - Bump `capsule-lint` peer dependency to `^0.6.3`.
...
- [#3](https://github.com/ActiveEngagement/capsule-capsulate/pull/3) [`441e5d4`](https://github.com/ActiveEngagement/capsule-capsulate/commit/441e5d4c9a98e091aa9d2c4289e1b19ca6ba2294) Thanks [@actengage](https://github.com/actengage)! - Update the capsule-lint peer dependency to latest

## 1.1.0

### Minor Changes

- [#1](https://github.com/ActiveEngagement/capsule-capsulate/pull/1) [`13bf7b5`](https://github.com/ActiveEngagement/capsule-capsulate/commit/13bf7b5d1ef69287fc50effab736974ba797a07c) Thanks [@actengage](https://github.com/actengage)! - Add upsert support to query-string replacements. A `SourceCodeReplacement` with no `from` (`{ key, to }`) now sets its key on every eligible link, creating it when absent instead of skipping. `useReplaceQueryStrings` exposes a `newSourceCodes` ref for adding params, and the `SourceCodeReplacement` union is split into named members (`KeyedSourceCodeReplacement`, `ValueSourceCodeReplacement`, `UpsertSourceCodeReplacement`). Keyed/value edits keep skipping absent keys, so existing behavior is unchanged.
...
- update capsule-lint to latest ([9e80ac8](https://github.com/ActiveEngagement/capsule-capsulate/commit/9e80ac8b4c844d91085f7be40af70867316097cf))
...
- updated capsule-lint ([d240dad](https://github.com/ActiveEngagement/capsule-capsulate/commit/d240dad23260b55fcdab15209d1ceffe8870ed25))
...
- updated capsule-lint ([e346275](https://github.com/ActiveEngagement/capsule-capsulate/commit/e346275414578bd1d1c9d02a097d2a442ecba231))

## [0.4.14](https://github.com/ActiveEngagement/capsule-capsulate/compare/v0.4.13...v0.4.14) (2023-12-19)

### Bug Fixes

- issue with template plugin stripping preview text without a template src ([6511ec5](https://github.com/ActiveEngagement/capsule-capsulate/commit/6511ec534dfb8cb5e0f37bd9092a0e7352b31522))
